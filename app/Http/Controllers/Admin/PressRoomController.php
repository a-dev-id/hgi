...
class PressRoomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('press-room.index')->with('message', $request->title . ' created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('press-room.index')->with('message', $request->title . ' edited Successfully');
    }
    ...
    public function destroy($id)
    {
        $data = PressRoom::find($id);
        $data->delete();
        return redirect()->route('press-room.index')->with('message', $data->title . ' deleted Successfully');
    }
}
