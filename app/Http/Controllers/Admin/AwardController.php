...
class AwardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('award.index')->with('message', $request->title . ' created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('award.index')->with('message', $request->title . ' edited Successfully');
    }
    ...
    public function destroy($id)
    {
        $data = Award::find($id);
        $data->delete();
        return redirect()->route('award.index')->with('message', $data->title . ' deleted Successfully');
    }
}
