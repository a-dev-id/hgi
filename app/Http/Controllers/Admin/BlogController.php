...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('blog.index')->with('message', $request->title . ' created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('blog.index')->with('message', $request->title . ' edited Successfully');
    }
    ...
    public function destroy($id)
    {
        $data = Blog::find($id);
        $data->delete();
        return redirect()->route('blog.index')->with('message', $data->title . ' deleted Successfully');
    }
}
