...
class WeddingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('wedding.index')->with('message', $request->title . ' created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('wedding.index')->with('message', $request->title . ' edited Successfully');
    }
    ...
    public function destroy($id)
    {
        $data = Wedding::find($id);
        $data->delete();
        return redirect()->route('wedding.index')->with('message', $data->title . ' deleted Successfully');
    }
}
