            ...
            <nav class="grow-menu navbar navbar-expand navbar-dark bg-dark bg-opacity-50">
                <div class="container-fluid justify-content-center text-uppercase">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3"><i class="fa fa-home"></i></a></li>
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Accommodations</a></li>
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Activities</a></li>
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Dining</a></li>
                    </ul>
                    ...
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Spa</a></li>
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Event</a></li>
                        <li class="nav-item"><a href="" class="nav-link text-white px-2 px-xl-3">Weddings</a></li>
