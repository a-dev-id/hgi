    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('spa.create') }}" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> New
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('spa.edit', [$data->id]) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST" action="{{ route('spa.destroy', [$data->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                ...
                <form method="POST" action="{{ route('spa-setting.update', [$setting->id]) }}" enctype="multipart/form-data" class="col-lg-12">
                    @method('PUT')
                    @csrf
                    <div class="card card-primary card-outline">
                        <div class="card-header">
