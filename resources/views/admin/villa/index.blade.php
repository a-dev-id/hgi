                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('villa.create') }}" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> New
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                {{-- new modal --}}
                                <form method="POST" action="{{ route('feature.store') }}" enctype="multipart/form-data" class="modal fade" id="modal_feature_add">
                                    @csrf
                                    <div class="modal-dialog">
                                        <div class="modal-content">
